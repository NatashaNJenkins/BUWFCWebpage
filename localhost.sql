...
--
-- Host: localhost
-- Generation Time: Jan 29, 2015 at 06:25 PM
...
('def', 'nmicic', 'Match', 'ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update', ''),
('def', 'nmicic', 'Match', 'Date', 2, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', 'UNI', '', 'select,insert,update', ''),
('def', 'nmicic', 'Match', 'Location', 3, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Match', 'Opposition', 4, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Match', 'Man_of_Match', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'UNI', '', 'select,insert,update', ''),
('def', 'nmicic', 'Match', 'Muppet_of_Match', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'UNI', '', 'select,insert,update', ''),
('def', 'nmicic', 'Match', 'Report', 7, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Player_Profiles', 'Player_ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update', ''),
('def', 'nmicic', 'Player_Profiles', 'Name', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Player_Profiles', 'Birthday', 3, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Player_Profiles', 'Course', 4, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Player_Profiles', 'YearOfStudy', 5, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Player_Profiles', 'YearsOfActivity', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Player_Profiles', 'Position', 7, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Player_Profiles', 'Tag', 8, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Player_Profiles', 'Hobbies', 9, NULL, 'YES', 'varchar', 1000, 1000, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(1000)', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Social_Events', 'ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update', ''),
('def', 'nmicic', 'Social_Events', 'Name', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Social_Events', 'Date', 3, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Social_Events', 'Location', 4, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Social_Events', 'Start_Time', 5, NULL, 'NO', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Social_Events', 'End_Time', 6, NULL, 'YES', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'Social_Events', 'Details', 7, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update', ''),
('def', 'nmicic', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', 'PRI', 'auto_increment', 'select,insert,update', ''),
('def', 'nmicic', 'users', 'username', 2, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', 'UNI', '', 'select,insert,update', ''),
('def', 'nmicic', 'users', 'password', 3, NULL, 'NO', 'varchar', 60, 60, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(60)', '', '', 'select,insert,update', '');
...
('BINLOG_CACHE_USE', '4014'),
('BINLOG_STMT_CACHE_DISK_USE', '0'),
('BINLOG_STMT_CACHE_USE', '736'),
('BYTES_RECEIVED', '5762493'),
('BYTES_SENT', '33012951'),
...
('COM_SHOW_CREATE_TABLE', '537'),
('COM_SHOW_CREATE_TRIGGER', '0'),
('COM_SHOW_DATABASES', '275'),
('COM_SHOW_ENGINE_LOGS', '0'),
('COM_SHOW_ENGINE_MUTEX', '0'),
('COM_SHOW_ENGINE_STATUS', '0'),
('COM_SHOW_EVENTS', '0'),
('COM_SHOW_ERRORS', '0'),
('COM_SHOW_FIELDS', '1116'),
('COM_SHOW_FUNCTION_STATUS', '4'),
('COM_SHOW_GRANTS', '44'),
('COM_SHOW_KEYS', '542'),
('COM_SHOW_MASTER_STATUS', '150'),
('COM_SHOW_OPEN_TABLES', '0'),
('COM_SHOW_PLUGINS', '1339'),
...
('COM_SHOW_STATUS', '437'),
('COM_SHOW_STORAGE_ENGINES', '43'),
('COM_SHOW_TABLE_STATUS', '1540'),
('COM_SHOW_TABLES', '474'),
('COM_SHOW_TRIGGERS', '274'),
('COM_SHOW_VARIABLES', '1449'),
('COM_SHOW_WARNINGS', '4'),
('COM_SLAVE_START', '0'),
('COM_SLAVE_STOP', '0'),
('COM_STMT_CLOSE', '0'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '5089'),
('CREATED_TMP_DISK_TABLES', '4368'),
('CREATED_TMP_FILES', '16'),
('CREATED_TMP_TABLES', '13622'),
('DELAYED_ERRORS', '0'),
('DELAYED_INSERT_THREADS', '0'),
('DELAYED_WRITES', '0'),
('FLUSH_COMMANDS', '1'),
('HANDLER_COMMIT', '15004'),
('HANDLER_DELETE', '28'),
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '8052'),
('HANDLER_READ_FIRST', '778'),
('HANDLER_READ_KEY', '4006'),
('HANDLER_READ_LAST', '1'),
('HANDLER_READ_NEXT', '27841'),
('HANDLER_READ_PREV', '8'),
('HANDLER_READ_RND', '385'),
('HANDLER_READ_RND_NEXT', '156431'),
('HANDLER_ROLLBACK', '727'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '19'),
('HANDLER_WRITE', '96377'),
('INNODB_BUFFER_POOL_PAGES_DATA', '1401'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '11372'),
('INNODB_BUFFER_POOL_PAGES_FREE', '129667'),
('INNODB_BUFFER_POOL_PAGES_MISC', '4'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '131072'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '213286'),
('INNODB_BUFFER_POOL_READS', '1347'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '38893'),
('INNODB_DATA_FSYNCS', '8927'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '24252416'),
('INNODB_DATA_READS', '1368'),
('INNODB_DATA_WRITES', '14436'),
('INNODB_DATA_WRITTEN', '193358848'),
('INNODB_DBLWR_PAGES_WRITTEN', '5686'),
('INNODB_DBLWR_WRITES', '236'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '5503'),
('INNODB_LOG_WRITES', '8344'),
('INNODB_OS_LOG_FSYNCS', '8518'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '6973440'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '55'),
('INNODB_PAGES_READ', '1346'),
('INNODB_PAGES_WRITTEN', '5686'),
('INNODB_ROW_LOCK_CURRENT_WAITS', '0'),
('INNODB_ROW_LOCK_TIME', '0'),
('INNODB_ROW_LOCK_TIME_AVG', '0'),
('INNODB_ROW_LOCK_TIME_MAX', '0'),
('INNODB_ROW_LOCK_WAITS', '0'),
('INNODB_ROWS_DELETED', '25'),
('INNODB_ROWS_INSERTED', '4029'),
('INNODB_ROWS_READ', '53209'),
('INNODB_ROWS_UPDATED', '5'),
('INNODB_TRUNCATED_STATUS_WRITES', '0'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '319575'),
('KEY_BLOCKS_USED', '91'),
('KEY_READ_REQUESTS', '11609'),
('KEY_READS', '91'),
('KEY_WRITE_REQUESTS', '61'),
('KEY_WRITES', '60'),
...
('OPEN_FILES', '570'),
('OPEN_STREAMS', '0'),
('OPEN_TABLE_DEFINITIONS', '471'),
('OPEN_TABLES', '502'),
('OPENED_FILES', '24046'),
('OPENED_TABLE_DEFINITIONS', '722'),
('OPENED_TABLES', '881'),
...
('QCACHE_FREE_MEMORY', '28402016'),
('QCACHE_HITS', '12995'),
('QCACHE_INSERTS', '2926'),
('QCACHE_LOWMEM_PRUNES', '0'),
('QCACHE_NOT_CACHED', '1135'),
('QCACHE_QUERIES_IN_CACHE', '2559'),
('QCACHE_TOTAL_BLOCKS', '5269'),
('QUERIES', '46872'),
('QUESTIONS', '46872'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '261195'),
('UPTIME_SINCE_FLUSH_STATUS', '261195');
...
('CHARACTER_SETS_DIR', '/usr/local/mysql-5.5.21-linux2.6-x86_64/share/charsets/'),
...
('PID_FILE', '/usr/local/mysql/data/lamp.scim.brad.ac.uk.pid'),
...
('LC_MESSAGES_DIR', '/usr/local/mysql-5.5.21-linux2.6-x86_64/share/'),
('LOG_OUTPUT', 'FILE'),
...
('FLUSH_TIME', '0'),
('GENERAL_LOG_FILE', '/usr/local/mysql/data/lamp.log'),
...
('SQL_MODE', ''),
('SSL_CA', '/usr/local/mysql/ssl/server.csr'),
...
('SLOW_QUERY_LOG_FILE', '/usr/local/mysql/data/lamp-slow.log'),
...
('HAVE_SSL', 'DISABLED'),
('SSL_KEY', '/usr/local/mysql/ssl/server.key'),
...
('SSL_CERT', '/usr/local/mysql/ssl/server.cert'),
...
('def', 'nmicic', 'PRIMARY', 'def', 'nmicic', 'Match', 'ID', 1, NULL, NULL, NULL, NULL),
('def', 'nmicic', 'Date', 'def', 'nmicic', 'Match', 'Date', 1, NULL, NULL, NULL, NULL),
('def', 'nmicic', 'Man_of_Match', 'def', 'nmicic', 'Match', 'Man_of_Match', 1, NULL, NULL, NULL, NULL),
('def', 'nmicic', 'Muppet_of_Match', 'def', 'nmicic', 'Match', 'Muppet_of_Match', 1, NULL, NULL, NULL, NULL),
('def', 'nmicic', 'Match_ibfk_1', 'def', 'nmicic', 'Match', 'Man_of_Match', 1, 1, 'nmicic', 'Player_Profiles', 'Player_ID'),
('def', 'nmicic', 'Match_ibfk_2', 'def', 'nmicic', 'Match', 'Muppet_of_Match', 1, 1, 'nmicic', 'Player_Profiles', 'Player_ID'),
('def', 'nmicic', 'PRIMARY', 'def', 'nmicic', 'Player_Profiles', 'Player_ID', 1, NULL, NULL, NULL, NULL),
('def', 'nmicic', 'PRIMARY', 'def', 'nmicic', 'Social_Events', 'ID', 1, NULL, NULL, NULL, NULL),
('def', 'nmicic', 'PRIMARY', 'def', 'nmicic', 'users', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'nmicic', 'username', 'def', 'nmicic', 'users', 'username', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2015-01-29 18:25:21', NULL, NULL, NULL, '', '', NULL),
('def', 'nmicic', 'Match', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 49152, 1804599296, '2015-01-27 15:23:27', NULL, NULL, NULL, '', '', NULL),
('def', 'nmicic', 'Player_Profiles', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 1804599296, '2015-01-27 14:49:49', NULL, NULL, NULL, '', '', NULL),
('def', 'nmicic', 'Social_Events', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 1804599296, '2015-01-27 15:22:41', NULL, NULL, NULL, '', '', NULL),
('def', 'nmicic', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 16384, 1804599296, '2015-01-26 19:13:01', NULL, NULL, NULL, '', '', NULL);
...
('binlog', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50521.0', NULL, NULL, 'MySQL AB', 'This is a pseudo storage engine to represent the binlog in a transaction', 'GPL', 'FORCE'),
...
('MRG_MYISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50521.0', NULL, NULL, 'MySQL AB', 'Collection of identical MyISAM tables', 'GPL', 'FORCE'),
('MyISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50521.0', NULL, NULL, 'MySQL AB', 'MyISAM storage engine', 'GPL', 'FORCE'),
('MEMORY', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50521.0', NULL, NULL, 'MySQL AB', 'Hash based, stored in memory, useful for temporary tables', 'GPL', 'FORCE'),
('CSV', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50521.0', NULL, NULL, 'Brian Aker, MySQL AB', 'CSV storage engine', 'GPL', 'FORCE'),
('InnoDB', '1.1', 'ACTIVE', 'STORAGE ENGINE', '50521.0', NULL, NULL, 'Oracle Corporation', 'Supports transactions, row-level locking, and foreign keys', 'GPL', 'ON'),
('INNODB_TRX', '1.1', 'ACTIVE', 'INFORMATION SCHEMA', '50521.0', NULL, NULL, 'Oracle Corporation', 'InnoDB transactions', 'GPL', 'ON'),
('INNODB_LOCKS', '1.1', 'ACTIVE', 'INFORMATION SCHEMA', '50521.0', NULL, NULL, 'Oracle Corporation', 'InnoDB conflicting locks', 'GPL', 'ON'),
('INNODB_LOCK_WAITS', '1.1', 'ACTIVE', 'INFORMATION SCHEMA', '50521.0', NULL, NULL, 'Oracle Corporation', 'InnoDB which lock is blocking which', 'GPL', 'ON'),
('INNODB_CMP', '1.1', 'ACTIVE', 'INFORMATION SCHEMA', '50521.0', NULL, NULL, 'Oracle Corporation', 'Statistics for the InnoDB compression', 'GPL', 'ON'),
('INNODB_CMP_RESET', '1.1', 'ACTIVE', 'INFORMATION SCHEMA', '50521.0', NULL, NULL, 'Oracle Corporation', 'Statistics for the InnoDB compression; reset cumulated counts', 'GPL', 'ON'),
('INNODB_CMPMEM', '1.1', 'ACTIVE', 'INFORMATION SCHEMA', '50521.0', NULL, NULL, 'Oracle Corporation', 'Statistics for the InnoDB compressed buffer pool', 'GPL', 'ON'),
('INNODB_CMPMEM_RESET', '1.1', 'ACTIVE', 'INFORMATION SCHEMA', '50521.0', NULL, NULL, 'Oracle Corporation', 'Statistics for the InnoDB compressed buffer pool; reset cumulated counts', 'GPL', 'ON'),
('PERFORMANCE_SCHEMA', '0.1', 'ACTIVE', 'STORAGE ENGINE', '50521.0', NULL, NULL, 'Marc Alff, Oracle', 'Performance Schema', 'GPL', 'FORCE'),
('BLACKHOLE', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50521.0', NULL, NULL, 'MySQL AB', '/dev/null storage engine (anything you write to it disappears)', 'GPL', 'ON'),
('ARCHIVE', '3.0', 'ACTIVE', 'STORAGE ENGINE', '50521.0', NULL, NULL, 'Brian Aker, MySQL AB', 'Archive storage engine', 'GPL', 'ON'),
('FEDERATED', '1.0', 'DISABLED', 'STORAGE ENGINE', '50521.0', NULL, NULL, 'Patrick Galbraith and Brian Aker, MySQL AB', 'Federated MySQL storage engine', 'GPL', 'OFF'),
('partition', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50521.0', NULL, NULL, 'Mikael Ronstrom, MySQL AB', 'Partition Storage Engine Helper', 'GPL', 'ON');
...
(5088, 'nmicic', 'localhost', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'nmicic', 'Match_ibfk_1', 'def', 'nmicic', 'PRIMARY', 'NONE', 'CASCADE', 'RESTRICT', 'Match', 'Player_Profiles'),
('def', 'nmicic', 'Match_ibfk_2', 'def', 'nmicic', 'PRIMARY', 'NONE', 'CASCADE', 'RESTRICT', 'Match', 'Player_Profiles');
...
('def', 'nmicic', 'latin1', 'latin1_swedish_ci', NULL);
...
('''nmicic''@''localhost''', 'def', 'nmicic', 'SELECT', 'NO'),
('''nmicic''@''localhost''', 'def', 'nmicic', 'INSERT', 'NO'),
('''nmicic''@''localhost''', 'def', 'nmicic', 'UPDATE', 'NO'),
('''nmicic''@''localhost''', 'def', 'nmicic', 'DELETE', 'NO'),
('''nmicic''@''localhost''', 'def', 'nmicic', 'CREATE', 'NO'),
('''nmicic''@''localhost''', 'def', 'nmicic', 'DROP', 'NO'),
('''nmicic''@''localhost''', 'def', 'nmicic', 'INDEX', 'NO'),
('''nmicic''@''localhost''', 'def', 'nmicic', 'ALTER', 'NO'),
('''nmicic''@''localhost''', 'def', 'nmicic', 'EXECUTE', 'NO'),
('''nmicic''@''localhost''', 'def', 'nmicic', 'CREATE VIEW', 'NO'),
('''nmicic''@''localhost''', 'def', 'nmicic', 'SHOW VIEW', 'NO'),
('''nmicic''@''localhost''', 'def', 'nmicic', 'CREATE ROUTINE', 'NO'),
('''nmicic''@''localhost''', 'def', 'nmicic', 'ALTER ROUTINE', 'NO'),
('''nmicic''@''localhost''', 'def', 'nmicic', 'TRIGGER', 'NO');
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '213454'),
('INNODB_BUFFER_POOL_READS', '1347'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '38893'),
('INNODB_DATA_FSYNCS', '8927'),
...
('def', 'nmicic', 'Match', 0, 'nmicic', 'PRIMARY', 1, 'ID', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'nmicic', 'Match', 0, 'nmicic', 'Date', 1, 'Date', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'nmicic', 'Match', 0, 'nmicic', 'Man_of_Match', 1, 'Man_of_Match', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'nmicic', 'Match', 0, 'nmicic', 'Muppet_of_Match', 1, 'Muppet_of_Match', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'nmicic', 'Player_Profiles', 0, 'nmicic', 'PRIMARY', 1, 'Player_ID', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'nmicic', 'Social_Events', 0, 'nmicic', 'PRIMARY', 1, 'ID', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'nmicic', 'users', 0, 'nmicic', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'nmicic', 'users', 0, 'nmicic', 'username', 1, 'username', 'A', 2, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-01-29 18:25:21', '2015-01-29 18:25:21', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2015-01-29 18:25:21', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'nmicic', 'Match', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 49152, 1804599296, 1, '2015-01-27 15:23:27', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'nmicic', 'Player_Profiles', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 1804599296, 2, '2015-01-27 14:49:49', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'nmicic', 'Social_Events', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 1804599296, 1, '2015-01-27 15:22:41', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'nmicic', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 16384, 1804599296, 4, '2015-01-26 19:13:01', NULL, NULL, 'latin1_swedish_ci', NULL, '', '');
...
('def', 'nmicic', 'PRIMARY', 'nmicic', 'Match', 'PRIMARY KEY'),
('def', 'nmicic', 'Date', 'nmicic', 'Match', 'UNIQUE'),
('def', 'nmicic', 'Man_of_Match', 'nmicic', 'Match', 'UNIQUE'),
('def', 'nmicic', 'Muppet_of_Match', 'nmicic', 'Match', 'UNIQUE'),
('def', 'nmicic', 'Match_ibfk_1', 'nmicic', 'Match', 'FOREIGN KEY'),
('def', 'nmicic', 'Match_ibfk_2', 'nmicic', 'Match', 'FOREIGN KEY'),
('def', 'nmicic', 'PRIMARY', 'nmicic', 'Player_Profiles', 'PRIMARY KEY'),
('def', 'nmicic', 'PRIMARY', 'nmicic', 'Social_Events', 'PRIMARY KEY'),
('def', 'nmicic', 'PRIMARY', 'nmicic', 'users', 'PRIMARY KEY'),
('def', 'nmicic', 'username', 'nmicic', 'users', 'UNIQUE');
...
-- Database: `nmicic`
--
CREATE DATABASE `nmicic` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `nmicic`;
